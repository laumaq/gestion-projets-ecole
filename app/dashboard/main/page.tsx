    ...
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="mb-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          {/* Mon horaire (employees uniquement) */}
          {userType === 'employee' && (
            <Link href="/tools/mon-horaire" className="block h-full">
              <div className="h-40 bg-white rounded-lg shadow-sm border-2 border-cyan-400 p-6 hover:shadow-md transition transform hover:scale-105 cursor-pointer flex flex-col justify-between overflow-hidden group">
                <div>
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-lg font-medium text-gray-900">Mon horaire</h3>
                  </div>
                  <p className="text-sm text-gray-500 line-clamp-2 group-hover:line-clamp-none transition-all">
                    Consultez vos heures de cours et la composition des groupes
                  </p>
                </div>
              </div>
            </Link>
