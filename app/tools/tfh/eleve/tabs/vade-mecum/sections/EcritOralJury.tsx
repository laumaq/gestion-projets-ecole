    ...
    <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm space-y-6">
      ...
      <div className="bg-teal-50 border-l-4 border-teal-400 rounded-r-lg p-5">
        ...
        <div className="space-y-3 text-gray-700 text-sm leading-relaxed">
          ...
          <p>
            Dans ton journal de bord, il est demandé, dans la mesure du possible, d'utiliser également la langue cible. Tes notes, réflexions, observations et traces de travail peuvent ainsi contribuer au développement de tes compétences linguistiques tout au long du projet.
          </p>
        </div>
      </div>
    </div>
